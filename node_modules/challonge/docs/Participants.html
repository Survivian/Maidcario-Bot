...
<head>
    <meta charset="utf-8">
    <title>Participants - Documentation</title>
...
<article>
    ...
    <h4 class="name" id="Participants"><span class="type-signature"></span>new Participants<span class="signature">(options)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_participants.js.html">api/participants.js</a>, <a href="api_participants.js.html#line4">line 4</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_participants.js.html">api/participants.js</a>, <a href="api_participants.js.html#line75">line 75</a>
    </li></ul></dd>
...
<div class="description">
  ...
  See the <a href="http://api.challonge.com/v1/documents/participants/create">Challonge API Doc</a> for a full list of object properties.
</div>
    ...
    <pre class="prettyprint"><code>client.participants.create({
...
<span class="param-type">string</span>
            ...
            <td class="description last">The url of the tournament to create the participants in</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">The participant to create.  See challonge docs for available properties.</td>
        </tr>
...
<div class="description">
  ...
  See the <a href="http://api.challonge.com/v1/documents/participants/destroy">Challonge API Doc</a> for a full list of object properties.
</div>
    ...
    <pre class="prettyprint"><code>client.participants.destroy({
  id: 'my-tournament-url',
...
<span class="param-type">string</span>
            ...
            <td class="description last">The url of the tournament to remove a participant from</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>participantId</code></td>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_participants.js.html">api/participants.js</a>, <a href="api_participants.js.html#line45">line 45</a>
    </li></ul></dd>
...
<div class="description">
  ...
  See the <a href="http://api.challonge.com/v1/documents/participants/index">Challonge API Doc</a> for a full list of object properties.
</div>
    ...
    <pre class="prettyprint"><code>client.participants.index({
  id: 'my-tournament-url',
  callback: (err, data) => {
    console.log(err, data);
  }
...
<span class="param-type">string</span>
            ...
            <td class="description last">The url of the tournament to get the participants from</td>
        </tr>
...
<span class="param-type">function</span>
    ...
    <h4 class="name" id="randomize"><span class="type-signature"></span>randomize<span class="signature">(obj)</span><span class="type-signature"></span></h4>
...
<div class="description">
  ...
  See the <a href="http://api.challonge.com/v1/documents/participants/randomize">Challonge API Doc</a> for a full list of object properties.
</div>
    ...
    <pre class="prettyprint"><code>client.participants.randomize({
  id: 'my-tournament-url',
  callback: (err, data) => {
    console.log(err, data);
  }
...
<span class="param-type">string</span>
            ...
            <td class="description last">The url of the tournament to randomize the participant seeds in</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_participants.js.html">api/participants.js</a>, <a href="api_participants.js.html#line103">line 103</a>
    </li></ul></dd>
...
<div class="description">
  ...
  See the <a href="http://api.challonge.com/v1/documents/participants/show">Challonge API Doc</a> for a full list of object properties.
</div>
    ...
    <pre class="prettyprint"><code>client.participants.show({
  id: 'my-tournament-url',
  participantId: '123456',
  callback: (err, data) => {
    console.log(err, data);
...
<span class="param-type">string</span>
            ...
            <td class="description last">The url of the tournament to get a participant in</td>
        </tr>
...
<div class="description">
  ...
  See the <a href="http://api.challonge.com/v1/documents/participants/update">Challonge API Doc</a> for a full list of object properties.
</div>
    ...
    <pre class="prettyprint"><code>client.participants.update({
  id: 'my-tournament-url',
  participantId: '123456',
  participant: {
...
<span class="param-type">string</span>
            ...
            <td class="description last">The url of the tournament to update a participant in</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">The participant object with updates.  See challonge docs for available properties.</td>
        </tr>
