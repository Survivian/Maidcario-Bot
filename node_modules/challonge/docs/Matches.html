...
<head>
    <meta charset="utf-8">
    <title>Matches - Documentation</title>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_matches.js.html">api/matches.js</a>, <a href="api_matches.js.html#line41">line 41</a>
    </li></ul></dd>
...
<div class="description">
  ...
  See the <a href="http://api.challonge.com/v1/documents/matches/index">Challonge API Doc</a> for a full list of object properties.
</div>
    ...
    <pre class="prettyprint"><code>client.matches.index({
...
<span class="param-type">string</span>
            ...
            <td class="description last">The url of the tournament to get the matches from</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_matches.js.html">api/matches.js</a>, <a href="api_matches.js.html#line69">line 69</a>
    </li></ul></dd>
...
<div class="description">
  ...
  See the <a href="http://api.challonge.com/v1/documents/matches/show">Challonge API Doc</a> for a full list of object properties.
</div>
    ...
    <pre class="prettyprint"><code>client.matches.show({
  id: 'my-tournament-url',
  matchId: '12345678',
  callback: (err, data) => {
    console.log(err, data);
...
<span class="param-type">string</span>
            ...
            <td class="description last">The url of the tournament to get the match from</td>
        </tr>
...
<div class="description">
  ...
  See the <a href="http://api.challonge.com/v1/documents/matches/update">Challonge API Doc</a> for a full list of object properties.
</div>
    ...
    <pre class="prettyprint"><code>client.matches.update({
  id: 'my-tournament-url',
  matchId: '12345678',
  match: {
    scoresCsv: '3-0',
...
<span class="param-type">string</span>
            ...
            <td class="description last">The url of the tournament to update the match in</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">The match object with updates.  See challonge docs for available properties.</td>
        </tr>
