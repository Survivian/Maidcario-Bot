...
<head>
    <meta charset="utf-8">
    <title>ErrorHandler - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ErrorHandler</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Internally used to handle errors from the API</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_error-handler.js.html">api/error-handler.js</a>, <a href="api_error-handler.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".handle"><span class="type-signature">(static) </span>handle<span class="signature">(res, resData, callback, format)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_error-handler.js.html">api/error-handler.js</a>, <a href="api_error-handler.js.html#line19">line 19</a>
    </li></ul></dd>
...
<span class="param-type">object</span>
        ...
        <tr>
                ...
                <td class="name"><code>resData</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last">the data contained in the response</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">the users callback function to call</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">the format of the response data (json, xml, etc)</td>
        </tr>
