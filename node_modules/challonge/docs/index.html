...
<div id="main">
    ...
    <section class="readme">
        <article><h2><a href="http://tidwell.github.io/node-challonge/">Full Documentation on GH Pages</a></h2><h2>Usage</h2><h3>Install</h3><pre class="prettyprint source lang-bash"><code>$ npm install challonge --save</code></pre><h3>Get all tournaments on your account</h3><pre class="prettyprint source lang-js"><code>const challonge = require('challonge');
