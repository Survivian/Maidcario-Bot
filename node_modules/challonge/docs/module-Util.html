...
<article>
    <div class="container-overview">
            ...
            <div class="description">Internal Utility methods</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="util.js.html">util.js</a>, <a href="util.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".serializeToQSParams"><span class="type-signature">(static) </span>serializeToQSParams<span class="signature">(a)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="util.js.html">util.js</a>, <a href="util.js.html#line70">line 70</a>
    </li></ul></dd>
...
<span class="param-type">object</span>
            ...
            <td class="description last">a javascript object</td>
        </tr>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="~camelToUnderscore"><span class="type-signature">(inner) </span>camelToUnderscore<span class="signature">(str)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="util.js.html">util.js</a>, <a href="util.js.html#line14">line 14</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="~convert"><span class="type-signature">(inner) </span>convert<span class="signature">(obj, conversionFn, newObject<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {object}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="util.js.html">util.js</a>, <a href="util.js.html#line40">line 40</a>
    </li></ul></dd>
...
<span class="param-type">object</span>
            ...
            <td class="description last">the object to massage the property names for</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>conversionFn</code></td>
...
<span class="param-type">function</span>
            ...
            <td class="description last">the function to be called passing the object key</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">the new object that is assembled (used in recursive calls)</td>
        </tr>
...
<span class="param-type">object</span>
    ...
    <h4 class="name" id="~underscoreToCamel"><span class="type-signature">(inner) </span>underscoreToCamel<span class="signature">(str)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="util.js.html">util.js</a>, <a href="util.js.html#line27">line 27</a>
    </li></ul></dd>
